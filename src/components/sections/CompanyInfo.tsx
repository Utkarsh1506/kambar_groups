        ...
        >
          <motion.div variants={fadeInUpVariants} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              <span className="font-bold">KAMBAR GROUPS</span> operates three specialized companies dedicated to providing premium FMCG products and distribution services across Goa.
            </p>
          </motion.div>
        </motion.div>
